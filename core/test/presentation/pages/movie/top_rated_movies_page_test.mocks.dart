...
import 'package:core/presentation/provider/movie/top_rated_movies_notifier.dart' as _i3;
...
class MockTopRatedMoviesNotifier extends _i1.Mock implements _i3.TopRatedMoviesNotifier {
  ...
  _i2.GetTopRatedMovies get getTopRatedMovies =>
      (super.noSuchMethod(Invocation.getter(#getTopRatedMovies), returnValue: _FakeGetTopRatedMovies_0())
  ...
  List<_i5.Movie> get movies =>
      (super.noSuchMethod(Invocation.getter(#movies), returnValue: <_i5.Movie>[]) as List<_i5.Movie>);
  @override
