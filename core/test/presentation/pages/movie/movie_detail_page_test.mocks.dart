...
import 'package:core/domain/usecases/movie/get_movie_recommendations.dart' as _i3;
...
import 'package:core/presentation/provider/movie/movie_detail_notifier.dart' as _i8;
...
class _FakeGetMovieWatchListStatus_2 extends _i1.Fake implements _i4.GetMovieWatchListStatus {}

class _FakeSaveMovieWatchlist_3 extends _i1.Fake implements _i5.SaveMovieWatchlist {}

class _FakeRemoveMovieWatchlist_4 extends _i1.Fake implements _i6.RemoveMovieWatchlist {}
...
class MockMovieDetailNotifier extends _i1.Mock implements _i8.MovieDetailNotifier {
  ...
  _i2.GetMovieDetail get getMovieDetail =>
      (super.noSuchMethod(Invocation.getter(#getMovieDetail), returnValue: _FakeGetMovieDetail_0())
          as _i2.GetMovieDetail);
  @override
  _i3.GetMovieRecommendations get getMovieRecommendations =>
      (super.noSuchMethod(Invocation.getter(#getMovieRecommendations), returnValue: _FakeGetMovieRecommendations_1())
          as _i3.GetMovieRecommendations);
  @override
  _i4.GetMovieWatchListStatus get getWatchListStatus =>
      (super.noSuchMethod(Invocation.getter(#getWatchListStatus), returnValue: _FakeGetMovieWatchListStatus_2())
          as _i4.GetMovieWatchListStatus);
  @override
  _i5.SaveMovieWatchlist get saveWatchlist =>
      (super.noSuchMethod(Invocation.getter(#saveWatchlist), returnValue: _FakeSaveMovieWatchlist_3())
          as _i5.SaveMovieWatchlist);
  @override
  _i6.RemoveMovieWatchlist get removeWatchlist =>
      (super.noSuchMethod(Invocation.getter(#removeWatchlist), returnValue: _FakeRemoveMovieWatchlist_4())
          as _i6.RemoveMovieWatchlist);
  @override
  _i7.MovieDetail get movie =>
      (super.noSuchMethod(Invocation.getter(#movie), returnValue: _FakeMovieDetail_5()) as _i7.MovieDetail);
  @override
  _i9.RequestState get movieState =>
      (super.noSuchMethod(Invocation.getter(#movieState), returnValue: _i9.RequestState.Empty) as _i9.RequestState);
  @override
